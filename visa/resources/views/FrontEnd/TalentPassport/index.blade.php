...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/talent_passport_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/talent-passport-visa" class="current"><i class="fas fa-angle-right"></i><span>Talent Passport Visa</span></a></li>
