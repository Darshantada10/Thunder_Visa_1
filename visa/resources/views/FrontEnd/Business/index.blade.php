...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/business_visa.js')}}"></script>
@endpush
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/business-visa" class="current"><i class="fas fa-angle-right"></i><span>Business Visa</span></a></li>
