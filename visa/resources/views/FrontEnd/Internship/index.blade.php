...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/internship_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/internship-visa" class="current"><i class="fas fa-angle-right"></i><span>Internship Visa</span></a></li>
