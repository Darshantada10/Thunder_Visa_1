...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/work_permit_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/work-permit-visa" class="current"><i class="fas fa-angle-right"></i><span>Work Permit Visa</span></a></li>
