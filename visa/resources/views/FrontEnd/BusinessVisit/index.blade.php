...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/business_visit_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/business-visit-visa" class="current"><i class="fas fa-angle-right"></i><span>Business Visit Visa</span></a></li>
