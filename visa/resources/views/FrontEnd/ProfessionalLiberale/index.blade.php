...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/professional_liberale_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/professional-liberale-visa" class="current"><i class="fas fa-angle-right"></i><span>Professional Liberale Visa</span></a></li>
