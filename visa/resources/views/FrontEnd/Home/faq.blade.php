            ...
            <div class="row">
                ...
                <div class="features-column col-lg-6">
                    <div class="inner-column">
                        ...
                        <figure class="image"><img src="{{asset('Assets/FrontEnd/images/resource/image-5.png')}}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                <div class="image-box">
                    ...
                    <figure class="image-1"><img src="{{asset('Assets/FrontEnd/images/resource/image-3.png')}}" alt=""></figure>
                    <figure class="image-2"><img src="{{asset('Assets/FrontEnd/images/resource/image-4.jpg')}}" alt=""></figure>
                    <figure class="plane-icon"><img src="{{asset('Assets/FrontEnd/images/resource/plane-2.png')}}" alt=""></figure>
                </div>
            </div>
            ...
            <div class="faq-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    ...
                    <ul class="accordion-box wow fadeInRight">
                        ...
                        <!--Block-->
                        <li class="accordion block">
                            <div class="acc-btn">France study visa requiements?
                                <div class="icon fa fa-angle-right"></div>
                            </div>
                            <div class="acc-content">
                                <div class="content">
