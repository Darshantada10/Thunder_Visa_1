...
@push('footer_scripts')
<script src="{{asset('Customs/FrontEnd/work_permit_cdi_visa.js')}}"></script>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="service-sidebar wow fadeInUp"
                            ...
                            <ul>
                            <li><a href="/work-permit-on-cdi-contract-basis" class="current"><i class="fas fa-angle-right"></i><span>Work Permit CDI Visa</span></a></li>
