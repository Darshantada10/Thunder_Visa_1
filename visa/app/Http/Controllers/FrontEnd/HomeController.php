...
class HomeController extends Controller
{
    ...
    public function GetActiveData()
    {
        ...
        $visa_boxes = VisaBox::where('visible', '=', '1')->orderBy('created_at', 'desc')->take(5)->get(['title', 'small_description', 'image']);
        ...
        $blogs = Blog::where('visible', '=', '1')->orderBy('created_at', 'desc')->take(3)->get();

        return response()->json([$logo,$navbar,$slider,$social_tags,$contact_info,$visa_boxes,$about,$video_title,$benefit,$visa_process,$blogs]);
